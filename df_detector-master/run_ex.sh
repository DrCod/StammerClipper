...
wav_file=sample_data/F_1_KSM_03_r1.wav

dsf_file=$(echo $wav_file | sed 's#sample_data#dsf#g' | sed 's#.wav#.dsfimg#g')
...
func/ext_dsffeat_dsfimg.py $dsf_file -m 'txtappend' -o 'dsf/temp.txt'
